1.0.0 (2020-09-02)
==================
Hydra 1.0 is finally out. See [blog post](https://hydra.cc/blog/2020/09/02/Hydra_1.0) for high level details.
...
This release notes are covering the changes since 1.0.0rc4.
To see the complete release notes for 1.0 take a look at 1.0.0rc1, 1.0.0rc2, 1.0.0rc3, 1.0.0rc4 and 1.0.0. 
